    ...
    <div className="space-y-6 animate-slide-up">
      <div>
        <h2 className="text-2xl font-bold text-white flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-accent-red/20 flex items-center justify-center"><Calculator className="w-5 h-5 text-accent-red" /></div>
          {t('calc.title')}
        </h2>
        <p className="text-sm text-gray-500 mt-1 ms-[52px]">{t('calc.subtitle')}</p>
      </div>

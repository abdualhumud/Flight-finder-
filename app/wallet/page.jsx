    ...
    <div className="space-y-4 md:space-y-6 animate-slide-up">
      <div>
        <h2 className="text-xl md:text-2xl font-bold text-white flex items-center gap-3">
          <div className="w-8 h-8 md:w-10 md:h-10 rounded-xl bg-accent-amber/20 flex items-center justify-center flex-shrink-0"><Wallet className="w-4 h-4 md:w-5 md:h-5 text-accent-amber" /></div>
          {t('wallet.title')}
        </h2>
        <p className="text-xs md:text-sm text-gray-500 mt-1 ms-11 md:ms-[52px]">{t('wallet.subtitle')}</p>
      </div>

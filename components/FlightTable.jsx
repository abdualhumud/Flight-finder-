    ...
    <div className={cn('glass glass-hover rounded-xl overflow-hidden transition-all animate-slide-up', config.border)}>
      <div className="p-4 cursor-pointer" onClick={() => setExpanded(!expanded)}>
        ...
        {flight.hasReturn && flight.returnDeparture && (
          <div className="mt-2 pt-2 border-t border-border-subtle/50 flex items-center gap-3 text-[10px] text-gray-500 ps-16">
            ...
            {flight.returnDuration && <span>{formatDuration(flight.returnDuration)}</span>}
          </div>
        )}
      </div>
      ...
      {expanded && (
        <div className="px-4 pb-4 border-t border-border-subtle pt-3 flex items-center gap-3 flex-wrap">
          <span className="text-[10px] text-gray-500 uppercase tracking-wider">{t('flight.bookOn')}</span>
